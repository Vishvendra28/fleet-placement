      ...
      <div className="relative w-full max-w-sm mx-4">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-[11px] text-slate-400 italic ml-[72px]">By ZAST Logisolutions</p>
            <p className="text-sm text-slate-500 mt-3">Sign in to your account</p>
          </div>
        ...
        <p className="text-center text-slate-400 text-xs mt-6">Planning साथी · By ZAST Logisolutions</p>
      </div>
    </div>
  );
}
